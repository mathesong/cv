---
title: Granville Matheson's Resume"
...
- `kinfitr`: R package to perform PET pharmacokinetic modelling
- `rwithings`: R package for querying the Withings activity API 
- `relfeas`: R package using reliability to estimate study feasibility
